        ...
        <>
            <PostCard>
                <CardHeader
                    ...
                    title={<Typography variant="h6">Restaurant Recommendation</Typography>}
                    subheader="August 5, 2023"
                />
                <CardMedia
                    component="img"
                    height="194"
                ...
                <CardContent>
                    <Typography variant="body2" color="text.secondary">
                        Hello everyone. I live near Banani area and was looking for some good chinese restaurants in Banani for family dining. Can anyone recommend a good chinese restaurant in that area?
                    </Typography>
                </CardContent>
