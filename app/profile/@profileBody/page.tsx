...
const ProfileBody = (props: any) => {
    const { profilePosts, profile , otherProfile, videoPosts , profileNetworks, acceptedProfileNetworks, recipientUser, profilePostsTmpDirUserImages, profilePostsTmpDirFigures, profilePostsCommentsTmpDirUserImages, videoPostsTmpDirUserImages, videoPostsTmpDirFigures, videoPostsCommentsTmpDirUserImages } = props;
